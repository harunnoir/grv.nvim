...
- Add `g:grv_inlay_hints_background`.
...
- Add `g:grv_dim_inactive_windows`.

### Changed

- Change default value of `g:grv_sign_column_background` to `'none'`.

## [1.2.4] - 2022-05-26

### Added

- Add `g:grv_spell_foreground`.
- Optimize `junegunn/limelight.vim`.
- Add FAQ for configuration options.
- Optimize `rhysd/clever-f.vim`.
- Optimize `rcarriga/nvim-dap-ui`.
- Add `g:grv_disable_terminal_colors`.
- Optimize `voldikss/vim-floaterm`.
- Support `g:grv_transparent_background == 2`.
...
- Split `g:grv_palette` into `g:grv_foreground` and `g:grv_colors_override`.
...
- Add `g:grv_diagnostic_text_highlight`
...
- Add `g:grv_diagnostic_line_highlight`.
- Add `g:grv_better_performance`.

### Changed

- Fix airline warning and error.
- Fix `g:grv_current_word` settings.
...
- Add `g:grv_statusline_style`.
- Add more available values for `g:grv_menu_selection_background`.
- Add `Substitute`, `TermCursor` and `TermCursorNC`.
- Optimize vim-sneak.
- Add `g:grv_sign_column_background`.
...
- Remove `g:grv_cursor_line_contrast`.

## [1.1.2] - 2020-04-04

### Added

- Add `g:grv_cursor_line_contrast`
...
- Fix terminal colors. [#24](https://github.com/sainnhe/grv/issues/24)
...
- Add `g:grv_palette`.
- Add `g:grv_enable_italic`.
- Add `g:grv_menu_selection_background`.

### Changed

- Refactor `colors/grv.vim`.
...
- New configuration option: `g:grv_visual`.
- New configuration option: `g:grv_current_word`.
...
- New option: `g:grv_lightline_kill_bold`.
...
[unreleased]: https://github.com/sainnhe/grv/compare/v1.2.5...HEAD
[1.2.5]: https://github.com/sainnhe/grv/compare/v1.2.4...v1.2.5
[1.2.4]: https://github.com/sainnhe/grv/compare/v1.2.3...v1.2.4
[1.2.3]: https://github.com/sainnhe/grv/compare/v1.2.2...v1.2.3
[1.2.2]: https://github.com/sainnhe/grv/compare/v1.2.1...v1.2.2
[1.2.1]: https://github.com/sainnhe/grv/compare/v1.2.0...v1.2.1
[1.2.0]: https://github.com/sainnhe/grv/compare/v1.1.3...v1.2.0
[1.1.3]: https://github.com/sainnhe/grv/compare/v1.1.2...v1.1.3
[1.1.2]: https://github.com/sainnhe/grv/compare/v1.1.1...v1.1.2
[1.1.1]: https://github.com/sainnhe/grv/compare/v1.1.0...v1.1.1
[1.1.0]: https://github.com/sainnhe/grv/compare/v1.0.1...v1.1.0
[1.0.1]: https://github.com/sainnhe/grv/compare/v1.0.0...v1.0.1
[1.0.0]: https://github.com/sainnhe/grv/compare/v0.3.4...v1.0.0
[0.3.4]: https://github.com/sainnhe/grv/compare/v0.3.3...v0.3.4
[0.3.3]: https://github.com/sainnhe/grv/compare/v0.3.2...v0.3.3
[0.3.2]: https://github.com/sainnhe/grv/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/sainnhe/grv/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/sainnhe/grv/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/sainnhe/grv/compare/v0.1.4...v0.2.0
[0.1.4]: https://github.com/sainnhe/grv/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/sainnhe/grv/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/sainnhe/grv/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/sainnhe/grv/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/sainnhe/grv/compare/v0.0.3...v0.1.0
[0.0.3]: https://github.com/sainnhe/grv/compare/v0.0.2...v0.0.3
[0.0.2]: https://github.com/sainnhe/grv/compare/v0.0.1...v0.0.2
[0.0.1]: https://github.com/sainnhe/grv/releases/tag/v0.0.1
